...
//  WordScramble
//
//  Created by Isaac Dyess on 6/29/23.
//
...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isDifferent(word: answer) else {
            wordError(title: "Word same as root word", message: "Use a different word!")
            return
        }
        guard isLong(word: answer) else {
            wordError(title: "Word is not long enough", message: "Use a longer word!")
            return
        }
